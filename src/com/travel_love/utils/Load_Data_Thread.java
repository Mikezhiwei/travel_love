		                  ...
		                  if(this.judement==1)//1代表登录操作JSON解析
		                  {
		                	 ...
		                	 EnrollActivity.res_map=res_map;
		                	  ...
		                	  UserInfoActivity.res_map=res_map;
		                	   ...
		                	   FirstPageActivity.load_data_list=com.travel_love.utils.JSONUtils.getJSONObject_messages(JSON_RES);
		                   }else if(this.judement==8){//我的历史发布的消息的读取
		                	   //res_list=com.travel_love.utils.JSONUtils.getJSONObject_messages(JSON_RES);
		                	   //MyHistoryMessageActivity.res_list=res_list;
		                   }else if(this.judement==9){//查看我和他人的两个人的消息的评论和回复
		                	   DetaiedMessageActivity.res_list=com.travel_love.utils.JSONUtils.getJSONArray_Comments(JSON_RES);
		                   }else if(this.judement==10){//查看我的消息个人的所有评论回复信息
		                	   DetaiedMessageActivity.res_list=com.travel_love.utils.JSONUtils.getJSONArray_Comments(JSON_RES);
		                   }
